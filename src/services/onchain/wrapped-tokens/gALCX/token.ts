...
import { GALCX_ABI } from 'web-app-shared/references/abi';
import { getALCXAssetData } from 'web-app-shared/references/assets';
...
import { gALCXContract } from 'web-app-shared/services/onchain/wrapped-tokens/gALCX/types';
