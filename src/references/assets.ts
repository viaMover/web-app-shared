...
export const getOHMAssetData = (network: Network): Token => {
  return {
    address: getNetworkAddress(network, 'OHM_V2_TOKEN_ADDRESS'),
    decimals: 9,
    symbol: 'OHM',
    iconURL: 'https://s2.coinmarketcap.com/static/img/coins/64x64/9067.png',
    name: 'Olympus',
    network
  };
};

export const getGOHMAssetData = (network: Network): Token => {
  return {
    address: getNetworkAddress(network, 'GOHM_TOKEN_ADDRESS'),
    decimals: 18,
    symbol: 'gOHM',
    iconURL: 'https://assets.coingecko.com/coins/images/21129/small/token_wsOHM_logo.png',
    name: 'Governance OHM',
    network
  };
};
